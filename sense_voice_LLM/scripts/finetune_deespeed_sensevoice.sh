...
dataset=librispeech
task=asr
train_scp_file_path=/aistor/sjtu/hpc_stor01/home/yangyi/data/${task}/train/
dev_scp_file_path=/aistor/sjtu/hpc_stor01/home/yangyi/data/${task}/dev/
...
++model_config.ctc_head=$ctc_head \
...
++train_config.validation_interval=1300 \
