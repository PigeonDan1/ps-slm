...
from . import LowShelfFilter, PeakingFilter, HighShelfFilter
from ....core.transforms_interface import add_transform
from ..base import PreProcess

@add_transform("seven_band_parametric_eq")
class SevenBandParametricEQ(PreProcess):
    """
    ...
    * 4216-9486 hz
    ...
    def randomize_parameters(self, samples: np.ndarray, sample_rate: int, accumulate_meta=None):
