import random
import numpy as np
from ..core.transforms_interface import BaseSpectrogramTransform, add_transform


@add_transform('spec_frequency_mask')
class SpecFrequencyMask(BaseSpectrogramTransform):
    ...
    def randomize_parameters(self, magnitude_spectrogram, accumulate_meta=None):
        super().randomize_parameters(magnitude_spectrogram, accumulate_meta)
