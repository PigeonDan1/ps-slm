#!/bin/bash
run_dir=/aistor/sjtu/hpc_stor01/home/wangchenghao/workingspace/ps-slm/Multitask # change this to your own dir, like: xxx/ps-slm/Multitask
cd  $run_dir
code_dir=.
...
ckpt_path=/aistor/sjtu/hpc_stor01/home/wangchenghao/workingspace/ps-slm/Multitask/exp/20251226-2247-asr-lorafalse_asr_instruct_do_psd_true_ds_1_ctc_posterior_true_voca_trans_false_instruction_first/ps-slm_epoch_5_step_2000 # ckpt_dir/
dataset=TED
task=asr
split=test-other
...
output_dir=/aistor/sjtu/hpc_stor01/home/wangchenghao/workingspace/ps-slm/Multitask/ckpt_text
