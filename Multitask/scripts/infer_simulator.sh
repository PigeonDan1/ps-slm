...
# 请确保输入文件路径正确
INPUT_JSONL="/aistor/sjtu/hpc_stor01/home/yangyi/data/multitask_large/train/multitask.jsonl"

# ================= 循环执行 =================
for BUCKET in "${BUCKETS[@]}"; do
    # 修改输出目录名称，以反映 Bucket 档位
    OUT_DIR="${run_dir}/data/multitask_large/train/simulator_B${BUCKET}"
