...
The TASU method converts text into pseudo-acoustic posteriors through the CTC posterior simulation (CPS) algorithm and projects them into the LLM word embedding space.
...
TASU方法，通过 CTC后验仿真 (CPS) 算法将文本转换为伪声学后验，投影到LLM词嵌入空间。
